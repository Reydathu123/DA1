...
public class XQuery {
    ...
    private static void demo1() {
      ...
      //  User user = XQuery.getSingleBean(User.class, sql, "trang1", "a");
       // System.out.println(user.toString());
    }

    private static void demo2() {
        String sql = "SELECT * FROM Users WHERE Fullname LIKE ?";
      //  List<User> list = XQuery.getBeanList(User.class, sql, "%a %");
    }
    public static BigDecimal getBigDecimal(String sql, Object... args) {
 ...
 public static int getIntValue(String sql, Object... args) {
        try (ResultSet rs = XJdbc.executeQuery(sql, args)) {
 ...
 public static double value(String sql, Object... args) {
        try {
            ResultSet rs = XJdbc.executeQuery(sql, args);
            if (rs.next()) {
                return rs.getDouble(1); // lấy giá trị cột đầu tiên
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    // Trả về giá trị kiểu int (nếu bạn cần)
